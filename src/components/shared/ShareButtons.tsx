    ...
    <div className="flex items-center gap-3 pb-6 border-b border-gray-100">
      ...
      {links.map(({ icon: Icon, label, href }) => (
        <a
          ...
          aria-label={label}
          className="w-8 h-8 flex items-center justify-center rounded-lg bg-gray-100 text-gray-500 hover:bg-navy/10 hover:text-navy transition-colors cursor-pointer"
        >
          <Icon />
        </a>
      ))}
